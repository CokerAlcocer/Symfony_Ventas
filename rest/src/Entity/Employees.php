 ...
 * Employees
 *
 * @ORM\Table(name="employees", indexes={@ORM\Index(name="IDX_BA82C30087BF8A72", columns={"reportsTo"}), @ORM\Index(name="IDX_BA82C300CD64AADC", columns={"officeCode"})})
 * @ORM\Entity
 */
class Employees
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="extension", type="string", length=10, nullable=true, options={"default"="NULL"})
     */
